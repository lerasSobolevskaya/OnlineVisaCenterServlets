							...
							<div
								...
								<div class="row-fluid">
									<div class="span10 offset1 formContainer customDDEForm">
										...
										<fieldset>
											<legend>
												<fmt:message key="update_visa_status" />
											</legend>
											<div class="row-fluid">
												<div class="span6">
													...
													<form action="MainServlet" method="get">
														<input type="hidden" name="command"
															value="update_visa_status"> <input type="hidden"
															name="visa_id" value="${visa.getId()}"> <select
															id="Visas-selected-deposit-country" name="visa_status"
															onchange="">
															<option selected>
															...
															value="<fmt:message key="update_visa_status"/>">
													</form>
												</div>
											</div>
										</fieldset>
