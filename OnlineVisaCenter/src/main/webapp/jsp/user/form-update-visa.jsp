							...
							<div class="row-fluid">
								<div class="span10 offset1 formContainer customDDEForm">
									<form id="stepOne" action="MainServlet" method="post">
										<input type="hidden" name="command" value="update_visa">
										<h1>
										...
										<fieldset>
											...
											<div class="row-fluid">
												<div class="span6">
													<input type="hidden" name="visa_id" value="${visa.getId()}">
											...
											<div class="row-fluid">
												<div class="span6">
													<label> <fmt:message key="visa_category" />
														...
														name="visa_category" onchange=""><c:if
															test="${not empty visa_category}">
															<option selected>
												...
												<div class="row-fluid">
													<div class="span6">
														<label> <fmt:message key="number_of_entries" />
															...
															name="number_of_entries" onchange=""><c:if
																test="${not empty number_of_entries}">
																<option selected>
											...
											<div class="row-fluid">
												<div class="span6">
													...
													</label> <input id="Visas-dde-number-days-travel" name="first_date"
														type="text" value="${visa.getFirstDate()}" />
													<p>
												...
												<div class="row-fluid">
													<div class="span6">
														...
														</label> <input id="Visas-dde-number-days-travel" name="last_date"
															type="text" value="${visa.getLastDate()}" />
														<p>
										...
										<input type="submit" name="_eventId_verify"
											id="_eventId_verify"
											value="<fmt:message key="save_changes"/>" />
									</form>
								</div>
							</div>
						</div>
