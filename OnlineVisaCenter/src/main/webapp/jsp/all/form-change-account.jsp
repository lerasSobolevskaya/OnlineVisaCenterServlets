								...
								<div class="portlet-borderless-container">
									<div class="portlet-body">
										<c:if test="${not empty dup_message}">
											<div class="alert alert-error" style="width: 25%">
												<c:out value="${dup_message}" />
											</div>
										</c:if>
										<c:if test="${not empty info_message}">
											<div class="alert alert-success" style="width: 22%">
												<strong><c:out value="${info_message}" /></strong>
											</div>
										</c:if>
										<form id="ModifyAccount-form" action="MainServlet"
											method="post">
											<input type="hidden" name="command"
												value="save_account_changes">
											<div class="offset1 row-fluid accueilUsagerAccount">
												<h2>
												...
												<div class="row-fluid">
													...
													<div class="row-fluid">
														<div class="span5">
															<label><fmt:message key="name" /></label> <input
																id="firstName" name="name" type="text"
																value="${user.getName()}" />
															<p>
														...
														<div class="row-fluid">
															<div class="span5">
																<label class=""><fmt:message key="second_name" /></label>
																<input id="firstName" name="second_name" type="text"
															...
															<div class="row-fluid">
																<div class="span5">
																	<label for="_58_emailAddress"> <fmt:message
																			key="email" />
																	</label> <input id="phoneNumber" name="email"
																		value="${user.getEmail()}" />
																	<p>
